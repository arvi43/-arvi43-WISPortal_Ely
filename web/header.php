	...
	<tr>
		...
		<td>
			<table id="Table_01" height="40" border="0" cellpadding="0" cellspacing="2px">
				...
				<tr>
					<td><a href="../logout/index.php" onMouseOut="MM_swapimgRestore()" onMouseOver="MM_swapImage('logout','','../images/button_logout_focus.png',1)">
						<img src="../images/button_logout.png" name="logout" id="logout" alt="" height="30"></td></a>
				</tr>
			</table>
		</td>
	</tr>
